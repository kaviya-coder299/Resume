		...
		<div class="cvBody flex pull-left" >
			<div class="cv-head">
				<div class="photo center ">
					...
					<span style="color: black;" id="cvname">Muhammad Kashif Iqbal</span>
				</div>
				...
				<div class="about-tab ">
					...
					<div class="about-details">
						<ul>
							<li id="cvphone1">0335-6910260</li>
							<li id="cvphone2" style="display: none">0346-6882215</li>
							<li id="cvaddress">Ada sanjar p/o shadan lund tehsil taunsa district dera ghaz khan</li>
						</ul>
					</div>
				</div>
				<div class="about-tab ">
					...
					<div class="about-details" style="background:#FBFBFB;color:black">
						<ul>
							<li id="cvskill1">Microsoft Office</li>
							<li id="cvskill2" style="display: none;">PHP,HTML,CSS</li>
							<li id="cvskill3" style="display: none;">Software Development</li>
	...
	<div class="well well-sm" style="width: 40%;margin-left: 8px;float: right;" >
		...
		<div class="tab-content">
		  <div id="cvHeader" class="tab-pane fade  ">
		    ...
		    <button class="pull-right btn btn-success" id="download">Finish and Download CV</button>
		    <br><br>
