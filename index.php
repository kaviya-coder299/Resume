...
<div style=";margin-left: 18%;padding-top: 122px" class="flex">
	<div class=" well" style="width: 52%; background-color: rgba(0, 0, 0, 0.4);  opacity: inherit;" id="mydiv">
		...
		<div class="well well-sm treb" style="position: relative;top: -122px;">
			<h4>Message From Admin</h4><img src="photo/iamfk.jpg" class="pull-right img-thumbnail " style="width: 133px;margin: 4px">
			this is Message From Admin . any type of notice it can include even imagethis is Message From Admin . any type of notice it can include even imagethis is Message From Admin . any type of notice it can include even imagethis is Message From Admin . any type of notice it can include even imagethis is Message From Admin . any type of notice it can include even imagethis is Message From Admin . any type of notice it can include even imagethis is latest notice . any type of notice it can include even imagethis is latest notice . any type of notice it can include even image
