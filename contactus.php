...
<div class="well well-sm" style="margin-left: 18%;padding-top: 122px;background-color: rgba(0, 0, 0, 0.4);  opacity: inherit;">
  <div class="panel panel-primary">
  		...
  		<div class="panel-body">
  			itha kashi apna address likhis k kitha shadi kresi kunwar kehri golaisa. 
  			baqi gami da hal ahwalitha kashi apna address likhis k kitha shadi kresi kunwar kehri golaisa. 
  			baqi gami da hal ahwalitha kashi apna address likhis k kitha shadi kresi kunwar kehri golaisa. 
  			baqi gami da hal ahwal
  			<br>
  			awain mahol hasi bus bia kia kro
  		</div>
  ...
  <div class="panel panel-primary">
  		...
  		<div class="panel-body">
  			<h3>
  				...
  				<br><br>
  				<i class="fa fa-book fa-fw"></i> asdfasdfasdfasd afdsdf sfad fasdffa
